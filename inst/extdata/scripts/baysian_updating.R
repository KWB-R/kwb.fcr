...
prior <- dunif(x = x, min = 25, max = 75)
quant_95 <- qunif(p = c(0.025, 0.975), min = 25, max = 75)
experiment1 <- dnorm(x = x, mean = 40, sd = diff(quant_95) / 0.5) # sehr schlecht
experiment2 <- dnorm(x = x, mean = 40, sd = diff(quant_95) / 1) # schlecht
experiment3 <- dnorm(x = x, mean = 40, sd = diff(quant_95) / 1.5) # mittel
experiment4 <- dnorm(x = x, mean = 40, sd = diff(quant_95) / 2) # gut
experiment5 <- dnorm(x = x, mean = 40, sd = diff(quant_95) / 2.5) # perfekt
...
experiment1a <- dnorm(x = x, mean = 35, sd = diff(quant_95) / 0.5) # sehr schlecht
experiment1b <- dnorm(x = x, mean = 65, sd = diff(quant_95) / 0.5) # sehr schlecht

experiment2a <- dnorm(x = x, mean = 35, sd = diff(quant_95) / 1) # schlecht
experiment2b <- dnorm(x = x, mean = 65, sd = diff(quant_95) / 1) # schlecht

experiment3a <- dnorm(x = x, mean = 35, sd = diff(quant_95) / 1.5) # mittel
experiment3b <- dnorm(x = x, mean = 65, sd = diff(quant_95) / 1.5) # mittel

experiment4a <- dnorm(x = x, mean = 35, sd = diff(quant_95) / 2) # gut
experiment4b <- dnorm(x = x, mean = 65, sd = diff(quant_95) / 2) # gut

experiment5a <- dnorm(x = x, mean = 35, sd = diff(quant_95) / 2.5) # perfekt
experiment5b <- dnorm(x = x, mean = 65, sd = diff(quant_95) / 2.5) # perfekt
...
experiment1a <- dnorm(x = x, mean = 40, sd = diff(quant_95) / 0.5) # sehr schlecht
experiment1b <- dnorm(x = x, mean = 40, sd = diff(quant_95) / 0.5) # sehr schlecht

experiment2a <- dnorm(x = x, mean = 40, sd = diff(quant_95) / 1) # schlecht
experiment2b <- dnorm(x = x, mean = 40, sd = diff(quant_95) / 1) # schlecht

experiment3a <- dnorm(x = x, mean = 40, sd = diff(quant_95) / 1.5) # mittel
experiment3b <- dnorm(x = x, mean = 40, sd = diff(quant_95) / 1.5) # mittel

experiment4a <- dnorm(x = x, mean = 40, sd = diff(quant_95) / 2) # gut
experiment4b <- dnorm(x = x, mean = 40, sd = diff(quant_95) / 2) # gut

experiment5a <- dnorm(x = x, mean = 40, sd = diff(quant_95) / 2.5) # perfekt
experiment5b <- dnorm(x = x, mean = 40, sd = diff(quant_95) / 2.5) # perfekt
...
experiment10_times <- dnorm(x = x, mean = 40, sd = diff(quant_95) / 2.5)
